...
var taskuu = new proj("taskbuddy", "Taskuu", "1.1.0", "Javascript", "download/Taskuu.Setup.exe", "Taskbuddy is a task-keeping app built using electronJS. It was my first \"real\" and last Javascript \nproject and was my sign to stay away from Javascript and web development.");
...
var schizle = new proj("SchizleLogo", "Schizle", "0.5.0", "C", "download/schizle.exe", "Schizle is a very simple scripting language made with barebones C. It supports advanced features that include, but are not limited to nested control flow and loops, io and file handling, various paradigms, and speed. A linux version is available in the original repository.");
...
function sortEntries() {
    docEntries = [fioDocs];
    projEntries = [wiced, schizle, fileInOut, taskuu];
