...
var tim = new proj(false, "Tindy", "Tindy", "1.0.0", "Rust, Python", "download/tindy.sh", "Tindy is a terminal app for taking notes in markdown. The app was written in rust, but the live preview feature comes a http server made in python.");
var projs = [tim, Contra, ratt, CompleteC, schizle, fileInOut, taskuu];
var projEntries;
